...
public class ManageConversionFactorController {
	...
	public ConversionFactorResponse addConversionFactor(@RequestBody Currency curr ) {
...
//	}	
	@RequestMapping(path = "/updateConvFactor", method = RequestMethod.POST)
	public ConversionFactorResponse UpdateConversionFactor(@RequestBody Currency curr ) {
